...
// APIClient manages communication with the Nightscout API API v14.2.3
...
type APIClient struct {
	...
	DevicestatusAPI *DevicestatusAPIService
	...
	TreatmentsAPI *TreatmentsAPIService
}
